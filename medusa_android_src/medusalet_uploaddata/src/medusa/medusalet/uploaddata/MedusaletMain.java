	...
	MedusaletCBBase cbSent = new MedusaletCBBase() {
    	public void cbPostProcess(Object data, String msg) 
    	{
    		...
    		if (uid != null) {
    			...
    			//
    			else MedusaTransferManager.requestUpload(runnerInstance.getMedusaletInstance(), uidList.getFirst(), pathList.getFirst(), reviewList.getFirst(), cbSent);
    		}
    	}
    };
    	...
    	public void cbPostProcess(Object data, String msg) 
    	{
    		...
    		if (data != null) {
        		...
        		if (cr.moveToFirst()) {
        			...
        			MedusaTransferManager.requestUpload(runnerInstance.getMedusaletInstance(), uidList.getFirst(), pathList.getFirst(), reviewList.getFirst(), cbSent);
