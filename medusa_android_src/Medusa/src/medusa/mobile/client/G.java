...
public class G 
{
	...
	public static String SERVER_URL = "http://128.125.121.204";	/* Task tracker location */
	public static String URIBASE_UPLOAD = SERVER_URL + "/medusa/tasktracker/web_tt_upload.php";
	public static String URIBASE_REPORT = SERVER_URL + "/medusa/tasktracker/web_tt_service.php";
	...
	//GCM
	public static String SENDER_ID = "485267995688";
